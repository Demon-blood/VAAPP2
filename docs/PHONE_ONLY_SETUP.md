...
5. After the run succeeds, open **Releases** and download `Full-Time-VA-Android-v0.9.6.apk`.
6. Install the downloaded `Full-Time-VA-Android-v0.9.6.apk`.
