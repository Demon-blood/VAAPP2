...
def test_v100_release_identity_is_consistent() -> None:
    ...
    assert 'REQUIRED_ANDROID_VERSION = "1.0.12"' in version
...
def test_android_uses_one_runtime_release_contract() -> None:
    ...
    assert "const String appRelease = '1.0.12';" in contract
    assert "const String minimumBackendVersion = '1.0.12';" in contract
