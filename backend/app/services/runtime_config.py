...
CONFIG_SECTIONS: dict[str, dict[str, Any]] = {
    ...
    "ai": {
        ...
        "fields": [
            ...
            {"key": "ai_fallback_base_url", "label": "Optional fallback API base URL", "type": "url", "required": False},
            {"key": "ai_fallback_api_key", "label": "Optional fallback API key", "type": "secret", "required": False},
            {"key": "ai_fallback_model", "label": "Optional fallback model", "type": "text", "required": False},
